...
```css
/* Typography Scale */
--font-xs:   0.75rem / 1.00rem;  /* 12px / 16px - Micro badges & Hotkeys */
--font-sm:   0.875rem / 1.25rem; /* 14px / 20px - Secondary body & Table cell */
--font-base: 1.000rem / 1.50rem; /* 16px / 24px - Standard body text */
--font-lg:   1.125rem / 1.75rem; /* 18px / 28px - Card headers & Modal titles */
--font-xl:   1.500rem / 2.00rem; /* 24px / 32px - Section headings */
--font-2xl:  2.250rem / 2.50rem; /* 36px / 40px - Scorecard Overall Score Display */
```
