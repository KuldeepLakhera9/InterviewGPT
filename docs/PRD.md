...
- **FR-INT-01**: Candidate can choose between two primary tracks:
  1. *Technical Track* (Data Structures & Algorithms, System Design, Frontend/Backend Architecture).
  2. *HR & Behavioral Track* (Leadership, Conflict Resolution, STAR Method, Culture Fit).
...
- **FR-EVAL-02**: Overall Score breakdown across 4 primary pillars:
  ...
  2. *Communication Clarity & Structure (0-100)*
  3. *Problem Solving & Methodology (0-100)*
  4. *Behavioral Framing / STAR Quality (0-100)*
