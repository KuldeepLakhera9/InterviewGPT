...
2. **UI State**: Instant banner: *"Reconnecting to interview stream... Session paused."*
...
3. **Candidate Experience**: Zero session crash; slight response delay with status badge: *"Synthesizing follow-up..."*
